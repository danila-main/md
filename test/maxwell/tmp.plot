...
plot 'exp_dist' u (rounded($1)):(UNITY) smooth frequency w boxes lc rgbcolor'red' t 'Generated distribution Vx', \
	 'th_dist' u 1:2 with points ps 0.7 pt 7 lc rgbcolor'green' t 'Maxwellian distribution Vx'
